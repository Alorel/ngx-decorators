...
[![Travis (.com) branch](https://img.shields.io/travis/com/Alorel/ngx-decorators/2.0.1.svg?style=flat-square)](https://travis-ci.com/Alorel/ngx-decorators)
[![Coveralls github branch](https://img.shields.io/coveralls/github/Alorel/ngx-decorators/2.0.1.svg?style=flat-square)](https://coveralls.io/github/Alorel/ngx-decorators)
...
```html
<script src="https://cdn.jsdelivr.net/npm/ngx-decorate@2.0.1/dist/ngx-decorators.umd.min.js"></script>
```
