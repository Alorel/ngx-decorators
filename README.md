...
[![Travis (.com) branch](https://img.shields.io/travis/com/Alorel/ngx-decorators/my-branch.svg?style=flat-square)](https://travis-ci.com/Alorel/ngx-decorators)
[![Coveralls github branch](https://img.shields.io/coveralls/github/Alorel/ngx-decorators/my-branch.svg?style=flat-square)](https://coveralls.io/github/Alorel/ngx-decorators)
...
Useful decorators for Angular 2 and above. Full API docs available [here](https://alorel.github.io/ngx-decorate)
